...
const awards = [
  {
    ...
    badge: "대상",
    desc: "3인 1팀으로 참가. 웹 개발자로서 AI와 Express를 크로스오버한 서버를 구축하고, 크롬 확장 프로그램으로 개발하여 클라이언트에서 쉽게 이용할 수 있도록 제작. 산업혁신 부문 대상 수상.",
  },
  {
    year: "2021",
    title: "현대오토에버 화이트 해커 경진대회",
    badge: "대상",
    desc: "3인 1팀으로 참가. 팀 내 유일한 포너블 분야 담당자로서 해당 분야 문제를 올솔브하며 대상 수상.",
  },
];
