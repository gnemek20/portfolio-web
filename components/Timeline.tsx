...
const events = [
  ...
  },
  {
    ...
    desc: "AI 에이전트 마켓플레이스 — 매니페스트 기반 동적 UI 와 ZIP 업로드 기반 자동 매니페스트 생성 흐름으로, 누구나 에이전트를 사고 팔 수 있도록 만드는 중",
    tag: "창업",
  },
  {
    period: "2026. 02 — 현재",
    title: "Dictector 재개",
    desc: "디스크에 영상을 저장한 뒤 오디오를 추출하던 1차 파이프라인을, 외부 전사 API에 URL을 위임하고 토큰 단위 결과를 메모리·DB 캐시로 재사용하는 방식으로 우회할 방법을 찾아 개발 재개",
    tag: "창업",
  },
];
